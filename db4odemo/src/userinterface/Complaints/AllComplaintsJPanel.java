...
public class AllComplaintsJPanel extends javax.swing.JPanel 
{
    ...
    private void initComponents() {
        ...
        lblInvestigator = new javax.swing.JLabel();
        txtInvestigatorFeedback = new javax.swing.JTextField();
        ...
        lblInvestigator.setText("OUEC Investigator:");
        add(lblInvestigator);
        lblInvestigator.setBounds(50, 680, 130, 16);
        add(txtInvestigatorFeedback);
        txtInvestigatorFeedback.setBounds(190, 670, 380, 30);
    ...
    private void btnSelectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelectActionPerformed
        ...
        if(null!=selectedComplaint.getOUECInvestigatorFeedback() && !selectedComplaint.getOUECInvestigatorFeedback().isEmpty()) {
            txtInvestigatorFeedback.setEnabled(true);
            txtInvestigatorFeedback.setText(selectedComplaint.getOUECInvestigatorFeedback());
        }
    ...
    private javax.swing.JLabel lblInvestigator;
    ...
    private javax.swing.JTextField txtInvestigatorFeedback;
